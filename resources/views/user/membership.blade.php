            ...
            <div class="membershipContainer " style="width: 350px; height: 450px;border-radius:8px; background-color: blue; padding:25px; box-shadow: 5px 7px 9px black;">
                <!-- <div class="d-flex justify-content-center"> -->
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control bg-white" name="pricing">
                        <option value="">Choose ...</option>
                        <option value="">7 days ($0)</option>
                        <option value="">14 days ($0)</option>
                        <option value="">21 days ($0)</option>
                      </select>
                    </div>                                      
                <!-- </div> -->
                <div class="offset-top-24">
                    <button class="btn btn-primary btn-block" type="submit" name="submit">Select </button>
                </div>
            </div>
            <div class="membershipContainer md-50" style="width: 350px; height: 450px;border-radius:8px; background-color: yellow; padding:25px; box-shadow: 5px 7px 9px black;">
                <!-- <div class="d-flex justify-content-center"> -->
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control bg-white" name="pricing">
                        <option value="">Choose...</option>
                        <option value="">7 days ($4.99)</option>
                        <option value="">14 days ($7.49)</option>
                        <option value="">21 days ($9.99)</option>
                      </select>
                    </div>                 
                <!-- </div> -->
                <div class="offset-top-24">
            ...
            <div class="membershipContainer" style="width: 350px; height: 450px;border-radius:8px; background-color: red; padding:25px;box-shadow: 5px 7px 9px black;">
                <!-- <div class="d-flex justify-content-center"> -->
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control bg-white" name="pricing">
                        <option value="">Choose ...</option>
                        <option value="">7 days ($9.99)</option>
                        <option value="">14 days ($14.99)</option>
                        <option value="">21 days ($19.99)</option>
                      </select>
                    </div>             
                <!-- </div> -->
                <div class="offset-top-24">
