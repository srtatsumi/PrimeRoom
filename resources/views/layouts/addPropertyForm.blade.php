                  ...
                  <div class="col-sm-8 col-md-6 col-lg-4">
                    ...
                    <form class=" text-left" method="post" action="{{route('addProperty')}}" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="checkbox" name="advertisementPlan[]" value="Silver" id="">Silver
                        <input type="checkbox" name="advertisementPlan[]" value="Gold" id="">Gold
                        <input type="checkbox" name="advertisementPlan[]" value="Platinum" id="">Platinum
                      </div>
